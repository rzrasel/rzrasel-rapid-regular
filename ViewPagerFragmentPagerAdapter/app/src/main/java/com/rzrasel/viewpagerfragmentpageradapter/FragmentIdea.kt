...
class FragmentIdea : Fragment() {
    private var title: String? = null
    private var page = 0

    companion object {
        fun getInstance(page: Int, title: String): FragmentIdea {
            val fragment = FragmentIdea()
            val args = Bundle()
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_idea, container, false)
